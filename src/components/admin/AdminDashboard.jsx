...
export default function AdminDashboard({ user }) {
  ...
  // Get current location for active navigation
  const location = useLocation();
  const isDaresRoute = location.pathname.includes('/dashboard/dares');
  const isHomeRoute = !isDaresRoute;
  ...
  return (
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <Link to="/dashboard" className="text-2xl font-bold text-blue-600 hover:text-blue-700">Dare2Earn</Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Routes>
          <Route path="dares" element={<DaresManagement />} />
          <Route 
            index 
            element={
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  ...
                  <Link 
                    to="/dashboard/dares"
                    className="bg-orange-600 hover:bg-orange-700 text-white rounded-lg p-6 flex items-center justify-center space-x-3 transition-colors"
                  >
